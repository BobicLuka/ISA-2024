...
INSERT INTO USERS (username, password, first_name, last_name, email, enabled, last_password_reset_date, penalty_points) VALUES ('user', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Marko', 'Markovic', 'bobicluka8899@gmail.com', true, '2017-10-01 21:58:58.508-07', 0);
...
INSERT INTO USERS (username, password, first_name, last_name, email, enabled, last_password_reset_date, penalty_points) VALUES ('user1', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Bobic', 'Luka', 'bobicluka8899@gmail.com', true, '2017-10-01 21:58:58.508-07', 0);
INSERT INTO USERS (username, password, first_name, last_name, email, enabled, last_password_reset_date, penalty_points, company_id) VALUES ('admin1', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Petar', 'Djuric', 'admin@example.com', true, '2017-10-01 18:57:58.508-07', 0, 3);
INSERT INTO USERS (username, password, first_name, last_name, email, enabled, last_password_reset_date, penalty_points) VALUES ('system_admin1', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Djura', 'Peric', 'system_admin@example.com', true, '2017-10-01 18:57:58.508-07', 0);
